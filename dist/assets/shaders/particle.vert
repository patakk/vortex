...
void main() {
    ...
    vec3 axis2 = axis;
    axis2.x = fbm3(vec2(index,index)*.001+u_seed*3.13, u_seed+0.0+u_time*.01)*1000. * index/444./2./1.3;
    axis2.y = fbm3(vec2(index,index)*.001+u_seed*3.13, u_seed+10.0+u_time*.01)*1000. * index/444./2./1.3;
